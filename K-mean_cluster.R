...
# Escalamos la media a 0

inseguridad = scale(USArrests, center = TRUE, scale = TRUE)
summary(inseguridad)

# cramos una base de datos nueva donde definiremos los clusters 
...
# se grafica cada sentroide 
#El grafico que sea de elipsey que tenga distancia entre cada estado 
